  ...
  return (
    <AnimatePresence>
      {profile && (
        ...
        className='w-[410px] h-full border-l bg-black/30 border-slate-700 fixed right-0 overflow-y-scroll z-50'
        >
          <div className='h-[60px] bg-primary flex items-center gap-6 fixed z-50 top-0 w-full'>
            ...
            <h1 className='text-white text-lg'>{`${selectedChat.isGroupChat ? "Group" : "Contact"} info`}</h1>

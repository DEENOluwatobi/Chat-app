    ...
    <AnimatePresence>
      {searchMsg && (
        <motion.div
          ...
          className='w-[410px] h-full border-l bg-secondary border-slate-700 fixed right-0 z-50'>

          <div className='h-[60px] bg-primary flex items-center gap-6 px-4'>
            ...
            <h1 className='text-white text-base'>Search messages</h1>
          </div>
